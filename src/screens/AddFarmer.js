...
import { View, Text, ScrollView, TouchableOpacity, Image,FlatList, Linking, PermissionsAndroid, ActivityIndicator } from 'react-native'
   ...
   useEffect(() => {
    ...
    const saveData = () => {
        ...
        try{
            ...
            console.log((data));
            Axios.post('http://unnmuktsaathiprodbackend-env-1.eba-a8422rfp.ap-south-1.elasticbeanstalk.com/farmer', data, {
                headers: {
    ...
    useEffect(() => {
        ...
        console.log('====================');
        console.log(profile);
        console.log('url', 'http://unnmuktsaathiprodbackend-env-1.eba-a8422rfp.ap-south-1.elasticbeanstalk.com/catchmentArea/'+JSON.parse(profile).orgUnitId);
        Axios.get('http://unnmuktsaathiprodbackend-env-1.eba-a8422rfp.ap-south-1.elasticbeanstalk.com/catchmentArea/'+JSON.parse(profile).orgUnitId, {
            headers: {
                'Authorization': 'Bearer ' + token,
            }
        }).then((res) => {
    ...
    const selectFile = async () => {
        ...
        try {
            ...
            Axios.post('http://unnmuktsaathiprodbackend-env-1.eba-a8422rfp.ap-south-1.elasticbeanstalk.com/images/1', formData, {
                headers: {
                    'Authorization': 'Bearer ' + token,
            ...
            >
                ...
                <Stack style={{ width: '100%', paddingLeft: 20, paddingRight:20, paddingBottom: 30 }}>
                    ...
                    <TouchableOpacity
                        onPress={() => {
                            // if (isEditable){
                            navigation.navigate('MapsForPinLocation', {setAddressCord: setAddressCords});
                            // }
                        }}
                        style={{
                            marginTop: 10,
                    ...
                    <TextInput
                        ...
                        variant="standard"
                        editable={false}
                        value={addressCords.length > 0 ? addressCords[0].latitude + ', ' + addressCords[0].longitude : ''}
                    ...
                    <Stack style={{ width: '100%', marginTop: 10 }} direction="row">
                        <Text style={{
                            ...
                            width: '50%',
                            alignSelf: 'center',
                        }}>Collect Raw Material Approval*</Text>
